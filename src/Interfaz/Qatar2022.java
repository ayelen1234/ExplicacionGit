...
public class Qatar2022 {
	...
	System.out.println(actual.calcularPorcentajeCompletado());
	...
	private static void visualizarFiguritasActuales(Scanner teclado, Album actual) {
	 actual.ordenarFiguritasActuales();
			...
			imprimirArray(actual.getFiguritasActuales());
		}
	...
	private static void imprimirArray( Figurita figuritasActuales[]) {
